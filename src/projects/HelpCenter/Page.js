  ...
  render() {
    ...
    return (
      <PortfolioPage big={big} id={id}>
        ...
        <TextContainer>
          <React.Fragment>
          Libraries are complex institutions filled with information and one of the ongoing challenges is connecting users to the people and resources they need. <strong>The reality is that many users want to find information on their own.</strong> Zendesk Guide provides a great way to organize and share resources and empowers users to find what they need on their own. 
