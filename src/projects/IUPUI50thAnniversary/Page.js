      ...
      <PortfolioPage big={big}>
        ...
        <TextContainer>
          <React.Fragment>
            ...
            to each client's needs. For phase one of this project, a client
            proposal was developed noting the scope of the new site, its
            adherance to web accessbility standards, and the number of custom
            features being implemented.
          </React.Fragment>
          <React.Fragment>
            Once the proposal was approved, phase two began. The goal of this
            phase was to develop a detailed understanding of the future site. To
            start, an internal kick-off meeting was held with the project team.
            We then met with the client to go over their requests for the site
            and to gather context to develop a timeline moving forward.
          </React.Fragment>
          <React.Fragment>
            For the proposed website, a stakeholder workshop was held. Post-its
            with high-level ideas based on what we learned from the client at
            this point were adhered to the meeting room walls and attendees were
            encouraged to review ideas and add more granular pieces of
            information that they’d like to see under each subject heading. The
            idea was to show the client this is what we know so far and we’d
            like for them to expand upon it. Stakeholders were then asked to
            identify what are the most important tasks, messages, and types of
            imagery they would like to see on the proposed site.
          </React.Fragment>
        </TextContainer>
        ...
        <TextContainer>
          <React.Fragment>
            ...
            from the previous phase. From the ideas gathered at the stakeholder
            workshop, the information architect (myself) and content lead sorted
            through piles of Post-its to tailor the topic and focus of the
            project.
          </React.Fragment>
          <React.Fragment>
            I then created a sitemap that was presented to the internal team for
            review and presented to the client for approval.
          </React.Fragment>
        </TextContainer>
        <ImageContainer pics={siteMap} big={big} />
        <TextContainer>
          <React.Fragment>
            Once the sitemap was approved, the creative phase began. This phase
            is where the real magic happens—wireframes are built, UI is styled,
            and content is written. For the build-out, I used Cascade WCMS
            Hannon Hill, (IU’s chosen content management system) and developed a
            high-fidelity wireframe with built-out pages and content notes. Once
            the wireframe was complete, an internal review was performed to
            identify any information gaps. The wireframe was then presented to
        ...
        <TextContainer>
          <React.Fragment>
            ...
            accessibility standards, and is usable from the client's perspective
            moving forward. Ultimately, this project helped me understand how to
            design within the constraints of the WCMS framework and university
            policy.
          </React.Fragment>
          <React.Fragment>
            Through my involvement in the stakeholder workshop, I was able to
            strengthen my facilitation skills. Hearing from multiple
            perspectives during card-sorting activity provided a great starting
            point for understanding the goals and context-of-use as well as
