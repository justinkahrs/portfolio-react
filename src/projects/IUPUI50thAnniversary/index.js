...
export default {
  ...
  subTitle: 'IA / IXD',
  hero,
  context: `Indiana University Purdue University (IUPUI) is celebrating their 50th anniversary through 2018-2019 and requested a website be created for all celebratory events, stories, and projects. The client wanted a “wow” factor with high-impact imagery and content that aligns with the school’s commitment to success and innovation in Indiana and beyond. The site’s audience consists of alumni, faculty, staff, students, donors, and the surrounding community.
  As I was not able to see this project to completion, due to a move across the country, I have shared my contributions as a proof of concept. You can find the live site `,
  ...
  process2: `The next phase of the development process focused on strategy. During this phase, the team created a strategy based on research from the previous phase. From the ideas gathered at the stakeholder workshop, the information architect (myself) and content lead sorted through piles of Post-its to tailor the topic and focus of the project.
    I then created a sitemap that was presented to the internal team for review and presented to the client for approval.
    `,
  siteMap,
  siteMapText: `Once the sitemap was approved, the creative phase began. This phase is where the real magic happens—wireframes are built, UI is styled, and content is written. For the build-out, I used Cascade WCMS Hannon Hill, (IU’s chosen content management system) and developed a high-fidelity wireframe with built-out pages and content notes. Once the wireframe was complete, an internal review was performed to identify any information gaps. The wireframe was then presented to the client for approval. 
    `,
  slideshow: [
    landingPage,
    events,
  ...
  slideShowText: `After sharing the wireframe with the client, I met with the front-end developer and designer on the project to discuss interaction design for custom functionalities. Websites at IU are built using atomic design principles where a page is made up of “sections” and each section can have multiple “chunks” (check out the IU Web Style Guide). When a client wants specific functionality outside of the system, things become a bit more complicated. In this project specifically, the client wanted a custom event feed to highlight anniversary events, an interactive timeline that allowed for multiple content types (e.g. text only, single image, carousel), and a story submission page.
  `,
  ...
  Through my involvement in the stakeholder workshop, I was able to strengthen my facilitation skills. Hearing from multiple perspectives during card-sorting activity provided a great starting point for understanding the goals and context-of-use as well as constructing the information architecture. 
  `,
}
