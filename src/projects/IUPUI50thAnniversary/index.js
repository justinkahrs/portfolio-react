...
export default {
  ...
  process: `The IU Comm development process is designed to be flexible to each client's needs. For phase one of this project, a client proposal was developed noting the scope of the new site, its adherance to web accessbility standards, and number of custom features. Once the proposal was approved, phase two began. The goal of this phase was to develop a detailed understanding of the future site. To start, an internal kick-off meeting was held with the project team. We then met with the client to go over their requests for the site and to gather context to develop a timeline moving forward. For the proposed website, a stakeholder workshop was held. Post-its with high-level ideas based on what we learned from the client were adhered to the meeting room walls and attendees were encouraged to review ideas and add more granular pieces of information that they’d like to see under each subject heading. The idea was to show the client this is what we know so far and we’d like for them to expand upon it. Stakeholders were then asked to identify what are the most important tasks, messages, and types of imagery they would like to see on the proposed site.`,
