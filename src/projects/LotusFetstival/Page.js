        ...
        <div className={big ? 'pageContainer' : ''}>
          ...
          <TextContainer>
            <React.Fragment>
              ...
              organization located in Bloomington, Indiana that collaborates
              with artists from around the world to facilitate educational
              programs and community events celebrating diversity and world
              culture.
            </React.Fragment>
            <React.Fragment>
              ...
              possible, inviting everyone to become part of the music and arts
              of the world.
            </React.Fragment>
            <React.Fragment>
              I chose to use this website as a case study because it would
              benefit from a detailed analysis of its information architecture
              and a new structure and design. In its current state, the site
              suffers from significant architectural issues that interfere with
              the overall understanding of the organization and its goals. See
              below for a high-fidelity wireframe.
            </React.Fragment>
          </TextContainer>
          ...
          <TextContainer>
            <React.Fragment>
              ...
              together strategy and scope documents that included a project
              brief, user demographics, personas, a content inventory, content
            ...
            <React.Fragment>
              ...
              users visiting the site hoping to learn about the festival. It
              also makes it difficult for users to navigate through the site
              easily.
            </React.Fragment>
            <React.Fragment>
              <span style={this.styles().subHeading}>Demographics</span>
              Users are made up of a wide array of multi-generational, local,
              and regional community members including live music fans, world
              music fans, artists, musicians, makers, volunteers, young parents,
          ...
          <TextContainer>
            <React.Fragment>
              ...
              and mP3 files. I then used column headings to further evaluate
              each page.
            </React.Fragment>
          </TextContainer>
          ...
          <TextContainer>
            <React.Fragment>
              ...
              suggests. Users of lotusfest.org will need to know how to attend
              and navigate the festival and have information about upcoming
              shows, prices, and locations readily available.
            </React.Fragment>
          </TextContainer>
          ...
          <TextContainer>
            <React.Fragment>
              ...
              ​navigation​ ​and​ ​access.​ ​Lotusfest.org​ ​has​ ​a​ ​broad
              scope​ ​of​ ​information​ ​about​ ​the​ ​Lotus​ ​Foundation​ ​and​
              ​its​ ​respective​ ​programs.​ ​By separating​ ​out​ ​the​
              ​festival​ ​content​ ​into​ ​its​ ​own​ ​site,​ ​stakeholders​
              ​gain​ ​the​ ​opportunity​ ​to tell​ ​the​ ​story​ ​of​ ​Lotus​
              ​World​ ​Music​ ​Festival​ ​and​ ​show​ ​how​ ​important​ ​this​
            ...
            <React.Fragment>
              ...
              recommended ​applying​ ​a​ ​narrower​ ​scope​ ​to​ ​the​
              ​existing​ ​architecture​ ​will lead​ ​to​ ​a​ ​better​
              ​user-experience​ ​for​ ​end-users​ ​and​ ​a​ ​more​ ​scalable​
              ​website​ ​for​ ​future festivals.
            </React.Fragment>
          </TextContainer>
